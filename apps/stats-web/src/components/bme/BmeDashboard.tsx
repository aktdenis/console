...
export const BmeDashboard: FC<BmeDashboardProps> = ({ dashboardData, statusHistory, viewMode, dependencies: d = DEPENDENCIES }) => {
  ...
  return (
    <Tabs defaultValue="summary">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 rounded-md border bg-muted/30 px-3 py-1.5 text-sm font-medium text-muted-foreground">
      ...
      <TabsContent value="summary" className="mt-6">
        <div className="flex flex-col gap-2">
          <d.SpendChartContainer denom={OUTSTANDING_ACT_DENOM} viewMode={viewMode} />
          <d.SpendChartContainer denom={VAULT_AKT_DENOM} viewMode={viewMode} />
          <d.SpendChartContainer denom={NET_AKT_BURNED_DENOM} viewMode={viewMode} />
          <d.SpendChartContainer denom={COLLATERAL_RATIO_DENOM} viewMode={viewMode} />
        </div>

        <p className="mb-4 mt-10 text-lg font-semibold tracking-tight text-foreground">Learn more</p>
          ...
          items={[
            {
              ...
              panel: <d.SpendChartContainer denom={AKT_BURNED_FOR_ACT_DENOM} className="rounded-t-none border-t-0" viewMode={viewMode} />
            },
            {
              ...
              panel: <d.SpendChartContainer denom={ACT_MINTED_DENOM} className="rounded-t-none border-t-0" viewMode={viewMode} />
            }
          ]}
        />
      </TabsContent>
          ...
          items={[
            {
              ...
              panel: <d.SpendChartContainer denom={ACT_BURNED_FOR_AKT_DENOM} className="rounded-t-none border-t-0" viewMode={viewMode} />
            },
            {
              ...
              panel: <d.SpendChartContainer denom={AKT_REMINTED_DENOM} className="rounded-t-none border-t-0" viewMode={viewMode} />
            }
          ]}
        />
      </TabsContent>
